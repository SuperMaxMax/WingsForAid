...
# loads
Ay_max=-26022 #+ D_load#N n=-2.87
Ay_min= 44538 #- D_load#N n=6.6
Az_min = -2813#N n=6.6
Az_max= 1685 #N n=-2.78
Ay_n2 = 12888 #n=2
Az_n2 = -803 #n=2
Bz_n2 = -7054 #n=2
By_n2 =  -12888 #n=2
...
t_notch_fus = abs(Ay_min)*Ksc/(2*sigma_yield_shear*(R_notch_fus-R_pin))
...
t_notch_fus_1 = abs(Ay_min)*Ksc/(2*sigma_yield*(R_notch_fus-R_pin))
...
t_notch_fus_2 = abs(Ay_max)*Ksc/(2*R_pin*sigma_yield)
