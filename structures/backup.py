...
n_stringers = 8             # [-] this is additional to already having 4 stringers at the corners
...
stringer_decr_x_ribs = 4    # [-] decrease stringers by n_stringer_decr_ribs every x ribs
...
while failure_tot == True:
    ...
    for rib_number, j in enumerate(spanwise_pos_sec):
        # print(rib_number, 'rib number')
        for i in j:
            # print(i, 'spanwise position')
            ### Airfoil ###
            ...
            if run_once_more == 1:# and i == spanwise_pos[-1]:
                # print(l_f_spar, t_f_spar, l_a_spar, t_a_spar, l_top, t_top, l_bot, t_bot, n_stringers_top, n_stringers_bot, A_s, A_tot)
